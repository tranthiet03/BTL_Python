...
class Cust_Win:
    def __init__(self, root, user_type):
        ...
        entry_ref=ttk.Entry(labelframeleft,textvariable=self.var_cust_ref,width=29,font=("arial",13,"bold"),state="readonly")
        ...
        txtIdNumber=ttk.Entry(labelframeleft,textvariable=self.var_cust_idnumber,font=("arial",13,"bold"),width=29)
        txtIdNumber.grid(row=9,column=1)

        #Address
        lblAddress=Label(labelframeleft,font=("arial",12,"bold"),text="Address:",padx=2,pady=6)
        lblAddress.grid(row=10,column=0,sticky=W)
        txtIdNumber=ttk.Entry(labelframeleft,textvariable=self.var_cust_address,font=("arial",13,"bold"),width=29)
        ...
        btnShowAll=Button(Table_Frame,text="Show",command=self.fetch_data,font=("arial",12,"bold"),bg="black",fg="gold",width=9)
